  ...
  <div class="hero w-full bg-[#FDF731] py-10">
    <div class="max-w-[1200px] mx-auto my-0 flex flex-col">
      ...
      >
        ...
        >
        : PARTIR DE SES ORIGINES, DE SES HÉRITAGES ET DE SES EXPÉRIENCES POUR
        MIEUX COMPRENDRE LE MONDE ET DIALOGUER AVEC LES AUTRES. LE PROJET
        S'INSCRIT AINSI DANS UNE VOLONTÉ DE DÉCLOISONNER LES IMAGINAIRES, DE
        QUESTIONNER LES HIERARCHIES CULTURELLES ET DE METTRE EN LUMIÈRE DES
        ŒUVRES,
        <span class="text-[#ed3F3F]"
          >DES REGARDS ET DES HISTOIRES SOUVENT MARGINALISÉS</span
        >.
      </p>
    </div>
  </div>
